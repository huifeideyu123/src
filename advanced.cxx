...
void Advanced::cb_fdm_i(Fl_Choice* o, void*) {
  if (strcmp(o->text(), "automatic selection") == 0){
              notrim->activate();
            } else {
              notrim->deactivate();
            };
...
Fl_Menu_Item Advanced::menu_fdm[] = {
 {"automatic selection", 0,  0, 0, 0, FL_NORMAL_LABEL, 0, 12, 0},
...
void Advanced::cb_rembrandt_i(Fl_Check_Button* o, void*) {
  if (o->value()) {
            anti_aliasing->deactivate();
          } else {
            anti_aliasing->activate();
          };
}
void Advanced::cb_rembrandt(Fl_Check_Button* o, void* v) {
  ((Advanced*)(o->parent()->parent()->user_data()))->cb_rembrandt_i(o,v);
}
...
void Advanced::cb_fgcom_disabled_i(Fl_Round_Button* o, void*) {
  if (o->value()){
  fgcom_hostname->deactivate();
  fgcom_port->deactivate();};
}
void Advanced::cb_fgcom_disabled(Fl_Round_Button* o, void* v) {
  ((Advanced*)(o->parent()->parent()->parent()->user_data()))->cb_fgcom_disabled_i(o,v);
}

void Advanced::cb_fgcom_builtin_i(Fl_Round_Button* o, void*) {
  if (o->value()){
  fgcom_hostname->deactivate();
  fgcom_port->deactivate();};
}
void Advanced::cb_fgcom_builtin(Fl_Round_Button* o, void* v) {
  ((Advanced*)(o->parent()->parent()->parent()->user_data()))->cb_fgcom_builtin_i(o,v);
}

void Advanced::cb_fgcom_standalone_i(Fl_Round_Button* o, void*) {
  if (o->value()){
  fgcom_hostname->activate();
  fgcom_port->activate();};
}
void Advanced::cb_fgcom_standalone(Fl_Round_Button* o, void* v) {
  ((Advanced*)(o->parent()->parent()->parent()->user_data()))->cb_fgcom_standalone_i(o,v);
}
...
Advanced::Advanced(Fl_Preferences& p):prefs(p) {
  { char* pGB = "高级选项";
    ...
    { pGB = "一般";
      ...
      { Fl_Button* o = new Fl_Button(610, 310, 25, 25, _("..."));
        o->labelsize(12);
...
ion of the graphics drivers should be used instead."));
        ...
        anti_aliasing->labelsize(12);
        anti_aliasing->textsize(12);
      } // Fl_Choice* anti_aliasing
      { Fl_Box* o = new Fl_Box(615, 475, 25, 25);
        Fl_Group::current()->resizable(o);
      } // Fl_Box* o
      page[5]->end();
    } // Fl_Group* page[5]
    ...
    { pGB = "网络";   
      ...
      { pGB = "FGCom选项";   
        ...
        { pGB = "舱门";   
          ...
          fgcom_port->value(16661);
          fgcom_port->deactivate();
        } // Fl_Value_Input* fgcom_port
        ...
        { pGB = "FGCom独立";   
          ...
          fgcom_standalone->callback((Fl_Callback*)cb_fgcom_standalone);
        } // Fl_Round_Button* fgcom_standalone
        o->end();
      } // Fl_Group* o
      page[7]->end();
    } // Fl_Group* page[7]
