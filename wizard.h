...
private:
  ...
  void cb_aircraft_mru_i(Fl_Browser*, void*);
  static void cb_aircraft_mru(Fl_Browser*, void*);
  Fl_Browser *aircraft;
  ...
  void cb_show_all_apt_i(Fl_Round_Button*, void*);
  static void cb_show_all_apt(Fl_Round_Button*, void*);
  Fl_Round_Button *show_installed_apt;
  void cb_show_installed_apt_i(Fl_Round_Button*, void*);
  static void cb_show_installed_apt(Fl_Round_Button*, void*);
  ...
  void cb_show_console_i(Fl_Check_Button*, void*);
  static void cb_show_console(Fl_Check_Button*, void*);
...
public:
  ...
  void preview_aircraft(bool desel_mru = true); 
private:
  void reset(); 
...
private:
  ...
  void update_aircraft_mru(); 
  void aircraft_mru_update(); 
  void aircraft_from_mru(); 
};
#endif
